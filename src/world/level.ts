  ...
  npcs: [
    {
      ...
      x: 1200,
      y: 500,
      lines: ['The metro station is east of here.', 'Five data shards went dark tonight. Bring them back online.'],
    },
    {
      name: 'Kira',
      x: 1850,
      y: 850,
      lines: ['Be careful around the industrial district.', 'I saw something glowing near the eastern block.'],
    },
    {
      name: 'Old Tomo',
      x: 700,
